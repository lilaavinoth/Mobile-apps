...
public class FacebookSenders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facebook_senders);

        recyclerView = findViewById(R.id.facelist);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Facebook Senders");
                    ...
                    protected void onBindViewHolder(@NonNull final SenderViewHolder holder, int position, @NonNull final Recieverdatastore model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(FacebookSenders.this,DetailedFacebookView.class);
