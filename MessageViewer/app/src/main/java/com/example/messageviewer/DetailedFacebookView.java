...
public class DetailedFacebookView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailed_facebook_view);
        ...
        recyclerView = findViewById(R.id.detailedfacebooklist);
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        sendername = sendername +"'s"+ " Detailed Facebook Messages";
